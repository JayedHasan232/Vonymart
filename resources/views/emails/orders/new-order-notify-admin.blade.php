...
New order form {{ $order->customer->name }}
@endcomponent
...
<table width="100%" style="text-align: left; margin: 0 auto">
    ...
    <tr>
        <th style="padding: 8px 16px; color: #333;border: 1px solid #f2f2f2">Name</th>
        <td style="padding: 8px 16px; color: #222; border: 1px solid #f2f2f2">{{$order->customer->name}}</td>
    </tr>
    <tr>
        <th style="padding: 8px 16px; color: #333;border: 1px solid #f2f2f2">Phone</th>
        <td style="padding: 8px 16px; color: #222; border: 1px solid #f2f2f2">{{$order->customer->phone}}</td>
    </tr>
    <tr>
        <th style="padding: 8px 16px; color: #333;border: 1px solid #f2f2f2">Email</th>
        <td style="padding: 8px 16px; color: #222; border: 1px solid #f2f2f2">{{$order->customer->email}}</td>
    </tr>
    <tr>
