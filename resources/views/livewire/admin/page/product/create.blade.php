<form class="box" action="{{ route('admin.products.store') }}" method="post">
    @csrf
            ...
            <div class="form-group col-12">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="specification" role="tabpanel" aria-labelledby="specification-tab">
                        <textarea class="form-control @error('specification') is-invalid @enderror" type="text" name="specification" id="specification" placeholder="Specification">{{ old('specification') }}</textarea>
                        @error('specification')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
