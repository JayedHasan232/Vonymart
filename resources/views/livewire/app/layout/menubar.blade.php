<nav class="menubar shadow-sm">
    <div class="{{ env('BS_CONTAINER') }} d-flex justify-content-between">
        <ul class="menubar-nav">
            ...
            <li class="nav-list"><a href="{{ route('about') }}" class="nav-link">About</a></li>
            <li class="nav-list"><a href="{{ route('contact') }}" class="nav-link">Contact</a></li>
        </ul>
        <ul class="menubar-nav d-none d-md-flex">
            <li class="nav-list">
                <a href="tel:+88{{ $info ? $info->mobile : '' }}" class="nav-link">
            ...
            <li class="nav-list">
                <a href="mailto:{{ $info ? $info->email : '' }}" class="nav-link">
